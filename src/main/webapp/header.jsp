<header class="p-3 bg-dark text-white sticky-top">
	<div
		...
		<a href="index"
			class="d-flex align-items-center justify-content-center col-1"> <img
			alt="" src="images/logo.png" height="40px">
		</a>
		...
		<div class="d-flex align-items-center pt-3">
			...
			<ul class="list-unstyled ps-0 d-flex justify-content-center">
				<c:forEach items="${ listeCategories}" var="categorie">
					<div class="dropdown">
						<button class="btn btn-dark dropdown-toggle btn_dropdown_category"
							...
							<c:forEach items="${ listeSousCateg}" var="sousCategorie">
								<c:if
									...
									<li><a class="dropdown-item"
										href="products?idSCat=${sousCategorie.id_sous_categorie }">${sousCategorie.titre }</a></li>
								</c:if>
							</c:forEach>
						</ul>
					</div>
			...
			<div class="d-flex align-items-center">
				<div class="tb_right_pull-right">
					<ul class="header_list_user">
						...
						<li>
							<div class="tbr-info">
								<a href="login" style="font-size: 0.7rem"><span><b>Inscription
											/ connexion</b></span></a>
							</div>
						</li>
						<%
						...
						<li>
							<div class="tbr-info align-items-center">
								<a href="deconnexion" style="font-size: 0.7rem"><span><b>D&eacute;connexion
									</b></span></a>
							</div>
						</li>
						<%
