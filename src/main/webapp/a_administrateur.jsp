		...
		<div class="content-page">
			<div class="content">
				...
				<div class="container-fluid">
					...
					<a href="a_administrateur?create=1"><button type="button"
						...
						<form class="col-5 d-flex flex-wrap" role="search" method="post"
							action=a_administrateur id="recherche">
							<input type="search"
							...
							<div class="col-12">
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Mot de passe</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="Some text value..." name="mot_de_passe">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Privileges</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="Some text value..." name="privileges">
											</div>
										</div>
										<button type="submit"
								...
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${administrateur.nom}" name="e-nom">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Email</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${administrateur.email}" name="e-email">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Mot de passe</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${administrateur.mot_de_passe}" name="e-mot_de_passe">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Privileges</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${administrateur.privileges}" name="e-privileges">
												</div>
										</div>
										<button type="submit"
							...
							<div class="card-box">
								...
								<div class="table-responsive">
									<table class="table mb-0 text-bg-dark">
										...
										<tbody>
											<c:forEach items="${ListAdministrateur}" var="administrateur">
												<tr>
													<th scope="row">${administrateur.id_administrateur}</th>
													<td>${administrateur.nom}</td>
													<td>${administrateur.email}</td>
													<td>${administrateur.mot_de_passe}</td>
													<td>${administrateur.privileges}</td>
													<td><a
														href="a_administrateur?edit=${administrateur.id_administrateur}"><button
																type="submit"
																class="btn btn-sm btn-icon btn-light waves-effect waves-light">
																<i class="mdi mdi-keyboard"></i>
															</button></a> <a
														href="a_administrateur?suppr=${administrateur.id_administrateur}"><button
																type="submit"
