		...
		<div class="content-page">
			<div class="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title">Coordonnees</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
					...
					<a href="a_coordonnees?create=1"><button type="button"
						...
						<form class="col-5 d-flex flex-wrap" role="search" method="post"
							action=a_coordonnees id="recherche">
							<input type="search"
							...
							<div class="col-12">
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Adresse</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="Some text value..." name="adresse">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Telephone</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="Some text value..." name="telephone">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Logo</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="Some text value..." name="logo">
											</div>
										</div>
										<button type="submit"
								...
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${coor.adresse}" name="e-adresse">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Telephone</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${coor.telephone}" name="e-telephone">
												</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Email</label>
							...
							<div class="card-box">
								...
								<div class="table-responsive">
									<table class="table mb-0 text-bg-dark">
										...
										<tbody>
											<c:forEach items="${ListCoordonnees}" var="coordonnees">
												<tr>
													<th scope="row">${coordonnees.id_coordonnees}</th>
													<td>${coordonnees.nom}</td>
													<td>${coordonnees.adresse}</td>
													<td>${coordonnees.telephone}</td>
													<td>${coordonnees.email}</td>
													<td><img alt="${coordonnees.nom}" src="${coordonnees.logo}" style="height: 35"></td>
													<td><a
														href="a_coordonnees?edit=${coordonnees.id_coordonnees}"><button
																type="submit"
																class="btn btn-sm btn-icon btn-light waves-effect waves-light">
																<i class="mdi mdi-keyboard"></i>
															</button></a> <a
														href="a_coordonnees?suppr=${coordonnees.id_coordonnees}"><button
																type="submit"
