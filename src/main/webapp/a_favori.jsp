					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title">Favoris</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
									...
									<table class="table mb-0 text-bg-dark">
										...
										<tbody>
											<c:forEach items="${ListFavori}" var="favori">
												<tr>
													<th scope="row">${favori.id_favori}</th>
													<td>${favori.produit.id_produit}-${favori.produit.titre_produit}</td>
													<td>${favori.utilisateur.prenom} ${favori.utilisateur.nom}</td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
