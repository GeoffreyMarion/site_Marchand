					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title">Commentaires</h4>
							</div>
						</div>
					</div>
					<!-- end page title -->
							...
							<div class="card-box">
								...
								<div class="table-responsive">
									<table class="table mb-0 text-bg-dark">
										...
										<tbody>
											<c:forEach items="${ListComm}" var="commentaire">
												<tr>
													<th scope="row">${commentaire.id_commentaire}</th>
													<td>${commentaire.commentaire}</td>
													<td>${commentaire.note}</td>
													<td>${commentaire.produit.id_produit}-${commentaire.produit.titre_produit}</td>
													<td>${commentaire.utilisateur.prenom} ${commentaire.utilisateur.nom}</td>
													<td><a
														href="a_commentaire?suppr=${commentaire.id_commentaire}"><button
																type="submit"
