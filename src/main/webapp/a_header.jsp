	...
	<ul class="list-unstyled topnav-menu float-right mb-0">
		<li class="dropdown notification-list"><a
			...
			aria-expanded="false"> <i class="dripicons-bell noti-icon"></i> <span
				class="badge badge-info noti-icon-badge">21</span>
		</a>
		...
		<li class="dropdown notification-list"><a
			...
			aria-expanded="false"> <img
				src="assets/images/users/avatar-4.jpg" alt="user-image"
				class="rounded-circle"> <span class="pro-user-name ml-1">
					${prenomuser} ${nomuser} <i class="mdi mdi-chevron-down"></i>
			</span>
		</a>
		...
		<div id="sidebar-menu">
			...
			<ul class="metismenu" id="side-menu">
				...
				<li><a href="javascript: void(0);"> <i
						class="dripicons-mail"></i> <span> Email </span> <span
				...
				<li><a href="javascript: void(0);"> <i
						class="dripicons-view-list"></i> <span> Tables </span> <span
						class="menu-arrow"></span>
				</a>
					<ul class="nav-second-level" aria-expanded="false">
