		...
		<div class="content-page">
			<div class="content">
				...
				<div class="container-fluid">
					...
					<a href="a_slide?create=1"><button type="button"
						...
						<form class="col-5 d-flex flex-wrap" role="search" method="post"
							action=a_fournisseur id="recherche">
							<input type="search"
							...
							<div class="col-12">
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										...
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Url</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="Some text value..." name="url">
											</div>
										</div>
										<button type="submit"
								...
								<div class="card-box">
									...
									<form class="form-horizontal" method="post">
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${slide.titre_slide}" name="e-titre">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Image</label>
											<div class="col-sm-9">
												<input type="text" class="form-control" id="simpleinput"
													value="${slide.image}" name="e-image">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-3 col-form-label" for="simpleinput">Url</label>
										...
										<tbody>
											<c:forEach items="${ListSlide}" var="slide">
												<tr>
													...
													<td><img alt="${slide.titre_slide}" src="${slide.image}" style="height: 35"></td>
													<td>${slide.url}</td>
													<td><a
														href="a_slide?edit=${slide.id_slide}"><button
																type="submit"
																class="btn btn-sm btn-icon btn-light waves-effect waves-light">
																<i class="mdi mdi-keyboard"></i>
															</button></a> <a
														href="a_slide?suppr=${slide.id_slide}"><button
																type="submit"
