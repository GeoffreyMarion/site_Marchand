				...
				<div class="container-fluid">
					...
					<div class="d-flex flex-wrap">
						<form class="col-5 d-flex flex-wrap" role="search" method="post"
							action=a_details_commande id="recherche">
							<input type="search"
							...
							<div class="card-box">
								...
								<div class="table-responsive">
									<table class="table mb-0 text-bg-dark">
										...
										<tbody>
											<c:forEach items="${ListDetails_commande}" var="details_commande">
												<tr>
													<th scope="row">${details_commande.id_details_commande}</th>
													<td>${details_commande.commande.id_commande}</td>
													<td>${details_commande.produit.id_produit}-${details_commande.produit.titre_produit}</td>
