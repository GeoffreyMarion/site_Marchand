...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 27 juil. 2022 à 11:51
...
(1, 'testTitre', 'NEW DESCRIPTION', 999, 'images/produits/Roman1.jpg', 12, 4, 2),
...
(9, 'manga1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 7, 'images/produits/Manga1.jpg', 13, 6, 4),
...
(15, 'livreEnfant1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 10, 'images/produits/LivreEnfant1.jpg', 16, 20, 10),
...
(22, 'sciencesHumaines1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 25, 'images/produits/SciencesHumaines1.jpg', 17, 30, 5),
...
(27, 'coffretIntegrale1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 19.99, 'images/produits/Coffret1.jpg\r\n', 4, 50, 20),
...
(32, 'vinyle1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 12, 'images/produits/Vinyle1.jpg', 5, 49, 10),
...
(37, 'instrumentMusique1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 200, 'images/produits/Instrument1.jpg', 8, 24, 20),
...
(40, 'carteGraphique1', 'Je suis la description Je suis la description Je suis la description Je suis la description', 899.99, 'images/produits/CarteGraphique1.jpg', 1, 33, 15),
...
(43, 'ssd1', 'Je suis la description Je suis la description', 32.31, 'images/produits/Ssd1.jpg', 10, 12, 5),
(44, 'dd1', 'Je suis la description Je suis la description', 61.99, 'images/produits/Dd1.jpg', 3, 8, 5);
...
INSERT INTO `slide` (`id_slide`, `titre_slide`, `image`, `url`) VALUES
(1, 'slide1', 'images/slides/slide1.jpg', ''),
(2, 'slide2', 'images/slides/slide2.jpg', ''),
(3, 'slide3', 'images/slides/slide3.jpg\r\n', '');
...
--
ALTER TABLE `details_commande`
  MODIFY `id_details_commande` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `entree_en_stock`
--
ALTER TABLE `entree_en_stock`
  MODIFY `id_entree_en_stock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
